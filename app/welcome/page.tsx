  ...
  return (
    ...
    >
      ...
      <header className="fixed top-0 w-full z-50 flex items-center justify-between px-6 py-4 flex-row-reverse bg-transparent max-w-[430px]">
        ...
        <button className="hover:opacity-80 transition-opacity" style={{ color: colors.primary }}>
      ...
      <main className="flex-1 flex flex-col items-center justify-center w-full max-w-md z-10 text-center mt-20">
        ...
        <div className="space-y-4">
          <h1 
            className="text-4xl md:text-5xl font-extrabold tracking-tight font-headline"
      ...
      <footer className="w-full max-w-md space-y-6 z-10 mb-8">
        <div className="flex flex-col gap-4">
          ...
          <Link href="/login">
            <button 
              className="w-full py-5 rounded-full border font-bold text-lg transition-all active:scale-[0.98] font-headline"
              style={{
